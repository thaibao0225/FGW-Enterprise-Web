...
namespace FGW_Enterprise_Web.AddminApp.Controllers
{
    public class UserController : BaseController
    {
        ...
        [HttpPost]
        public async Task<IActionResult> GetMail(GetEmailRequest request)
        {
            ...
            var result = await _userApiClient.SendMailGoogleSmtp(sender, reciever, title, body, account, pass);
