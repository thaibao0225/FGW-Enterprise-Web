...
namespace FGW_Enterprise_Web.BackEndAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           // services.AddTransient<IValidator<RegisterRoleRequest>, RegisterRoleRequestValidator>();
            //services.AddTransient<IValidator<RegisterRoleRequest>, RegisterRoleRequestValidator>();
            services.AddTransient<IRoleService, RoleService>();
            services.AddTransient<IUserService, UserService>();
            services.AddTransient<IPublicDeadLineService, PublicDeadLineService>();
            services.AddTransient<IManageDeadLineService, ManageDeadLineService>();
            services.AddTransient<IStorageService, FileStorageService>();
            services.AddTransient<IManageCourseService, ManageCourseService>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Swagger fff V1");
            });
