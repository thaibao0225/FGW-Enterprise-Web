...
namespace FGW_Enterprise_Web.Application.System.Users
{
    public class UserService : IUserService
    {
        ...
        public async Task<ViewModels.Common.ApiResult<string>> Authencate(LoginRequest request)
        {
        ...
        public async Task<ViewModels.Common.ApiResult<ViewModels.Common.PagedResult<UserVm>>> GetUserPaging(GetUserPagingRequest request)
        {
