...
namespace FGW_Enterprise_Web.Data.Migrations
{
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "DeadlineCate",
                columns: new[] { "dlCate_Id", "dlCate_CreateBy", "dlCate_CreateDate", "dlCate_Description", "dlCate_ModifiedBy", "dlCate_Name", "dlCate_Status" },
                values: new object[,]
                {
                    { "00001", "Vo Thi Quynh Nhu", new DateTime(2021, 4, 8, 23, 55, 11, 946, DateTimeKind.Local).AddTicks(753), "Web project", null, "EnterpriseWeb ", null },
                    { "00002", "Vo Thi Quynh Nhu", new DateTime(2021, 4, 8, 23, 55, 11, 946, DateTimeKind.Local).AddTicks(9150), "Web project", null, "Project", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("f49e4348-718f-43e3-b1f6-6dc89c5bb4fd"), "cd875d44-5e99-479d-89ee-21e32702375f", "Admin", "Admin", "Adminstrator role" },
                    { new Guid("f49e4348-718f-43e3-b1f6-6dc89c5bb5ff"), "d02f1f24-223b-48d6-9f37-435454f87c47", "User", "User", "User role" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("360e601e-92f2-4f08-832b-604a21293258"), 0, "eb17368c-8a9b-45c3-a174-eeee929ddf7f", "nhuvtqgcs18612@fpt.edu.vn", true, false, null, "nhuvtqgcs18612@fpt.edu.vn", "Admin", "AQAAAAEAACcQAAAAEM94WImkY8Bvuk2c/GrMdgKU6CuK9Jp+zZjd0d1CY0VVsbb6sejKQOU4RtL7TETp3w==", null, false, "", false, "Admin", new DateTime(2021, 3, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Vo Thi Quynh Nhu", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null });
